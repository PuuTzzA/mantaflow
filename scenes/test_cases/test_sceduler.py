...
HIGHRES_PATHS = [
    ['../scenes/test_cases/3d_highres/3d_highres_obstacle_cfl_high_conserving_2_polynomial_local_cfl.json', True],
    ['../scenes/test_cases/3d_highres/3d_highres_obstacle_cfl_high_traditional_RK4_2_polynomial_local_cfl.json', True],
